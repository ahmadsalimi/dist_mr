...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=b'\n\x14\x64river-service.proto\x12\x07\x64ist_mr\"\x1c\n\x0cHelloRequest\x12\x0c\n\x04name\x18\x01 \x01(\t\" \n\rHelloResponse\x12\x0f\n\x07message\x18\x01 \x01(\t2L\n\rDriverService\x12;\n\x08SayHello\x12\x15.dist_mr.HelloRequest\x1a\x16.dist_mr.HelloResponse\"\x00\x62\x06proto3'
)
...
_HELLOREQUEST = _descriptor.Descriptor(
  name='HelloRequest',
  full_name='dist_mr.HelloRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='dist_mr.HelloRequest.name', index=0,
...
_HELLORESPONSE = _descriptor.Descriptor(
  name='HelloResponse',
  full_name='dist_mr.HelloResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='message', full_name='dist_mr.HelloResponse.message', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
HelloRequest = _reflection.GeneratedProtocolMessageType('HelloRequest', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:dist_mr.HelloRequest)
  })
...
HelloResponse = _reflection.GeneratedProtocolMessageType('HelloResponse', (_message.Message,), {
  ...
  '__module__' : 'driver_service_pb2'
  # @@protoc_insertion_point(class_scope:dist_mr.HelloResponse)
  })
...
_DRIVERSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='SayHello',
    full_name='dist_mr.DriverService.SayHello',
    index=0,
